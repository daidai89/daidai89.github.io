...
function bottomForm(search_form) {
    if (search_form.catid.value == 1) {
        ...
        document.search_form.submit();
        return false;
	} else if (search_form.catid.value == 7) {
        search_form.action = "index.html";
        document.search_form.submit();
        return false;
	} else if (search_form.catid.value == 8) {
        search_form.action = "index.html";
        document.search_form.submit();
        return false;
	} else if (search_form.catid.value == 9) {
        search_form.action = "index.html";
        document.search_form.submit();
        return false;
	} else if (search_form.catid.value == 10) {
        search_form.action = "index.html";
        document.search_form.submit();
        return false;
	} else if (search_form.catid.value == 11) {
        search_form.action = "index.html";
        document.search_form.submit();
        return false;
	} else if (search_form.catid.value == 12) {
        search_form.action = "index.html";
        document.search_form.submit();
        return false;
	}else if (search_form.catid.value == 13) {
        search_form.action = "index.html";
        document.search_form.submit();
        return false;
	}
