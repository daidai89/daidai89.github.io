 ...
 function(a)
	...
	a.flexslider=function(c,b)
				...
				a(window).resize(function()
					{
						...
						d.sliderTimer=setTimeout(function(){d.flexAnimate(d.currentSlide)},300)
					})
			}
			d.vars.start(d)
		};
		d.flexAnimate=function(f,e)
		{
				...
				if(!d.vars.animationLoop)
				{
					...
					if(d.vars.animation.toLowerCase()=="slide")
					{
						if(d.currentSlide==0&&f==d.count-1&&d.vars.animationLoop)
							...
							else{d.slideString=(-1*(f+d.cloneOffset))*d.slides.filter(":first").width()+"px"}
						}
						d.container.animate(
						...
						function()
							{d.animating=false;d.currentSlide=f;d.vars.after(d)}
							)
					}
				}
			};
			...
			{
				if(!d.animating)
				{var e=(d.currentSlide==d.count-1)?0:d.currentSlide+1;d.flexAnimate(e)}
			};
			d.pause=function()
			{clearInterval(d.animatedSlides);if(d.vars.pausePlay){d.pausePlay.removeClass("pause").addClass("play").text("play")}};
			d.resume=function()
			{
				d.animatedSlides=setInterval(d.animateSlides,d.vars.slideshowSpeed);
				if(d.vars.pausePlay)
			...
			d.getTarget=function(e)
			{
				...
				else{return(d.currentSlide==0)?d.count-1:d.currentSlide-1}
			};
			d.init()
		};
